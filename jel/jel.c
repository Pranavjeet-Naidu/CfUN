...
// acts as constructor for abuf type
...
void editorRefreshScreen(){
  ...
  char buf[32];
  snprintf(buf, sizeof(buf),"\x1b[%d;%dH", (E.cy - E.rowoff)+1, (E.rx - E.coloff)+1); //use 1-index
